...
public class SetupPhase {
    ...
    private static void moveGuardian(RobotController rc) throws GameActionException {
        if(RobotPlayer.flagGoal[RobotPlayer.guardianID].equals(rc.getLocation())) return;
        ...
        Direction[] dirs = {dir, dir.rotateLeft(), dir.rotateRight(),
                ...
                dir.rotateLeft().rotateLeft().rotateLeft(), dir.rotateRight().rotateRight().rotateRight(), dir.opposite()};
